This fork is identical to https://github.com/cryptomator/aur-bin but it just enables otlined try icons which are visible on both a light and a dark background.
